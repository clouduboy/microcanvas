...
PROGMEM const unsigned char gfx_js_ship[] = {
  /*16x9*/ 0x10, 0x92, 0xba, 0xff, 0xff, 0xff, 0x38, 0x38, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
PROGMEM const unsigned char gfx_enemy_1[] = {
  /*13x9*/ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x38, 0x10, 0x00, 0x10, 0x38, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
PROGMEM const unsigned char gfx_enemy_3[] = {
  /*9x10*/ 0x20, 0xa0, 0xa0, 0xa0, 0xa0, 0xa0, 0x00, 0xa0, 0x40, 0x00, 0x00, 0x02, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00 };
PROGMEM const unsigned char gfx_enemy_4[] = {
  /*13x9*/ 0x20, 0xa0, 0xa0, 0xa0, 0xa0, 0xa0, 0x00, 0xa0, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
PROGMEM const unsigned char gfx_intro[] = {
  /*96x27*/  };
...
const byte GFX_ENEMY_4_WIDTH = 13;
const byte GFX_ENEMY_4_HEIGHT = 9;
const byte GFX_ENEMY_4_FRAMES = 0;
const byte GFX_ENEMY_4_FRAMESIZE = 26;
...
////// CUSTOM SETUP //////
possible_enemies[ 0 ] = gfx_enemy_1;
possible_enemies[ 1 ] = gfx_enemy_2;
possible_enemies[ 2 ] = gfx_enemy_3;
generate_stars( MAX_STARS );
score = 0;
x_spaceship = 10;
y_spaceship = 32;
sprite_enemies[ 0 ] = possible_enemies[ (int)floor( random() * 3 ) ];
x_enemies[ 0 ] = (int)floor( random() * WIDTH + WIDTH / 2 );
y_enemies[ 0 ] = (int)floor( random() * HEIGHT );
sprite_enemies[ 1 ] = possible_enemies[ (int)floor( random() * 3 ) ];
x_enemies[ 1 ] = (int)floor( random() * WIDTH + WIDTH / 2 );
y_enemies[ 1 ] = (int)floor( random() * HEIGHT );
sprite_enemies[ 2 ] = possible_enemies[ (int)floor( random() * 3 ) ];
...
arduboy.print( "[A] to restart!" );
  ...
  if (gfx_js_ship) {
  if (enemy_sprite == gfx_enemy_1) crash = collides( gfx_js_ship, x_spaceship, y_spaceship, GFX_JS_SHIP_WIDTH, GFX_JS_SHIP_HEIGHT, gfx_enemy_1, x_enemies[ idx ], y_enemies[ idx ], GFX_ENEMY_1_WIDTH, GFX_ENEMY_1_HEIGHT, "true" ); else if (enemy_sprite == gfx_enemy_2) crash = collides( gfx_js_ship, x_spaceship, y_spaceship, GFX_JS_SHIP_WIDTH, GFX_JS_SHIP_HEIGHT, gfx_enemy_2, x_enemies[ idx ], y_enemies[ idx ], GFX_ENEMY_2_WIDTH, GFX_ENEMY_2_HEIGHT, "true" ); else if (enemy_sprite == gfx_enemy_3) crash = collides( gfx_js_ship, x_spaceship, y_spaceship, GFX_JS_SHIP_WIDTH, GFX_JS_SHIP_HEIGHT, gfx_enemy_3, x_enemies[ idx ], y_enemies[ idx ], GFX_ENEMY_3_WIDTH, GFX_ENEMY_3_HEIGHT, "true" );
}
  if (crash) {
  game_over();
}
  ...
  int is_dead = false;
  if (enemy_sprite == gfx_enemy_1) is_dead = collides( gfx_rocket, x_rockets[ rck_idx ], y_rockets[ rck_idx ], GFX_ROCKET_WIDTH, GFX_ROCKET_HEIGHT, gfx_enemy_1, x_enemies[ idx ], y_enemies[ idx ], GFX_ENEMY_1_WIDTH, GFX_ENEMY_1_HEIGHT, "true" ); else if (enemy_sprite == gfx_enemy_2) is_dead = collides( gfx_rocket, x_rockets[ rck_idx ], y_rockets[ rck_idx ], GFX_ROCKET_WIDTH, GFX_ROCKET_HEIGHT, gfx_enemy_2, x_enemies[ idx ], y_enemies[ idx ], GFX_ENEMY_2_WIDTH, GFX_ENEMY_2_HEIGHT, "true" ); else if (enemy_sprite == gfx_enemy_3) is_dead = collides( gfx_rocket, x_rockets[ rck_idx ], y_rockets[ rck_idx ], GFX_ROCKET_WIDTH, GFX_ROCKET_HEIGHT, gfx_enemy_3, x_enemies[ idx ], y_enemies[ idx ], GFX_ENEMY_3_WIDTH, GFX_ENEMY_3_HEIGHT, "true" );
  ;
  if (is_dead) {
  x_enemies[ idx ] = WIDTH;
  ...
  x_enemies[ index ] -= 1;
  if (enemy_sprite == gfx_enemy_1) arduboy.drawBitmap( x_enemies[ index ], y_enemies[ index ], gfx_enemy_1, GFX_ENEMY_1_WIDTH, GFX_ENEMY_1_HEIGHT, WHITE ); else if (enemy_sprite == gfx_enemy_2) arduboy.drawBitmap( x_enemies[ index ], y_enemies[ index ], gfx_enemy_1, GFX_ENEMY_1_WIDTH, GFX_ENEMY_1_HEIGHT, WHITE ); else if (enemy_sprite == gfx_enemy_3) arduboy.drawBitmap( x_enemies[ index ], y_enemies[ index ], gfx_enemy_1, GFX_ENEMY_1_WIDTH, GFX_ENEMY_1_HEIGHT, WHITE );
}
