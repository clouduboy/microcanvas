...
`);
  ...
  gfxIntro = game.loadSprite(`! clouduboy 96x17
.....#####.....##..............................##..............##.............................
...##.....#...#..#............................#..#............#..#............................
..#...##...#..#..#............................#..#............#..#............................
..#..#..#...#.#..#...#####....##....##....#####..#..##....##..#..#####.....#####....##....##..
...
game.loop(function() {
  ...
  if (intro) {
    if (game.frameCount - introAfter < 3*game.frameRate) {
      game.drawImage(gfxIntro, 16, game.height/2-gfxIntro.height/2);
    } else {
	    intro = false;
...
*/
const game_timer_animation_duration = game.frameRate*1 +game.frameRate*13
...
function game_timer_animation() {
  ...
  // MIN(currentframe-startframe, duration) - capped at "duration"
  const duration1 = game.frameRate*1, duration2 = game.frameRate*13
  let x
